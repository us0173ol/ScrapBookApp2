...
public class MainActivity extends AppCompatActivity implements MainListCursorAdapter.ItemContentsChangedListener{
    ...
    //ListView mListView = (ListView) findViewById(R.id.pictures_comments_listview);
...
//
//        final Button newCommentsAndPics = (Button) findViewById(R.id.newCommentsAndPicturesButton);
//        newCommentsAndPics.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//
//                Intent launchListConfig = new Intent(MainActivity.this, ListConfig.class);
//                //setResult(RESULT_OK, launchListConfig);
//                setContentView(R.layout.list_configuration_layout);
//                startActivityForResult(launchListConfig, LIST_RESULTS);
//                //finish();
//
//            }
//        });
...
//            if (requestCode == LIST_RESULTS){
//                ListView listView = (ListView)findViewById(R.id.pictures_comments_listview);
//
...
//
    ...
    private void takePhoto() {
        ...
        if (pictureIntent.resolveActivity(getPackageManager()) == null) {
            ...
            String imageFilename = "scrapbookapp2_" + new Date().getTime();  //Create a unique filename including a timestamp
            ...
            try {
                ...
                imageFileUri = FileProvider.getUriForFile(MainActivity.this, "com.bignerdranch.android.scrapbookapp2", imageFile);
    ...
    private void saveToMediaStore() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            MediaStore.Images.Media.insertImage(getContentResolver(), mImage, "scrapbookapp2", "Photo taken by scrapbookapp2");
        } else {
